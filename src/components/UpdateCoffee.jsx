...
const UpdateCoffee = () => {
    const {_id,name,quantity,price,taste,photo,details,category} =useLoaderData()
  ...
  timer: 1500
    ...
    <input type="text" name="quantity" defaultValue={quantity} className="input w-full" placeholder="Chef Name" />
    </fieldset>
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
    ...
    <input type="text" name="taste" className="input w-full" defaultValue={taste} placeholder="Taste Name" />
    </fieldset>
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
